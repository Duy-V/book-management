...
/* build-hook-start *//*00001*/try { require('c:\\users\\duy vo\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.240\\out\\buildhook\\index.js').default({tool: 'nest.js'}); } catch(cjsError) { try { import('file:///c:/users/duy%20vo/.vscode/extensions/wallabyjs.console-ninja-1.0.240/out/buildhook/index.js').then(m => m.default.default({tool: 'nest.js'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
